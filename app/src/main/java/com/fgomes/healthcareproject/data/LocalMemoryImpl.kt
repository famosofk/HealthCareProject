...
class LocalMemoryImpl : LocalMemory {
    ...
    override fun getMockList(type: ScreenType): MutableList<BaseModel> {
        return if (type == ScreenType.CONSULTATION) {
            mutableListOf(
                ConsultationModel(id = "1", title = "João Pedro - Ortopedista", date = "25/11/2021", doctor = ""),
                ConsultationModel(id = "2", title = "Karen - Cardiologista", date = "26/11/2021", doctor = ""),
                ConsultationModel(id = "3", title = "Joana - Oftalmologista", date = "27/11/2021", doctor = ""),
                ConsultationModel(id = "4", title = "Henderson - Endrocrino", date = "28/11/2021", doctor = ""),
            )
        } else {
            mutableListOf(
